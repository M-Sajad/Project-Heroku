...
target = "g0BbJhD005e1873929c98d7dc2ee7c8c"

# created By EK_Venus & EK_Venus
			...
			try:
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						...
						elif msg.get("text").startswith("🗿") or msg.get("text").startswith("🗿🗿") or msg.get("text").startswith("🗿🗿🗿) or msg.get("text").startswith("🗿🗿🗿🗿") or msg.get("text").startswith("🗿🗿🗿🗿🗿") or msg.get("text").startswith("🗿🗿🗿🗿🗿🗿"):
							try:
								bot.sendMessage(target,'مراپ ومعرفت' ,message_id=msg.get("message_id"))
							except:
								print("err marap")
